...
export const products: Product[] = [
  // ───── 요리 키트 ─────
  {
    ...
    cloudinaryId: 'nonsan/ugly-onion-soup-kit',
    sizes: ['1인분', '2인분'],
    stock: 55,
    origin: '충남 논산시',
  },
  ...
  // ───── 디저트 키트 ─────
  {
    ...
    cloudinaryId: 'nonsan/ugly-pear-tart-kit',
    sizes: ['1인분'],
    stock: 40,
    origin: '충남 논산시',
  },
  ...
  },
  {
    ...
    cloudinaryId: 'nonsan/ugly-apple-pear-crumble-kit',
    sizes: ['1인분'],
    stock: 45,
    origin: '충남 논산시',
  },
  ...
  // ───── 음료 키트 ─────
  {
    ...
    cloudinaryId: 'nonsan/ugly-carrot-pear-juice-kit',
    sizes: ['1인분', '2인분'],
    stock: 60,
    origin: '충남 논산시',
  },
  {
    ...
    cloudinaryId: 'nonsan/ugly-tomato-gazpacho-kit',
    sizes: ['1인분'],
    stock: 48,
    origin: '충남 논산시',
  },
  ...
  },
  {
    ...
    cloudinaryId: 'nonsan/ugly-seasonal-gift-set',
    sizes: ['3종 세트'],
    stock: 30,
    origin: '충남 논산시',
  },
