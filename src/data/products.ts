export type Product = {
  ...
  description: string
  cloudinaryId: string   // Cloudinary public_id 또는 https:// 외부 이미지 URL
  sizes?: string[]
  stock: number
  origin: string
}
...
export const products: Product[] = [
  // ───── 요리 키트 ─────
  {
    ...
    cloudinaryId: u('1547592180-85f173990554'),
    sizes: ['1인분', '2인분'],
    stock: 55,
    origin: '충남 논산시',
  },
  ...
  },
  {
    ...
    cloudinaryId: u('1579954115545-a4a2f2e4285e'),
    sizes: ['1인분'],
    stock: 45,
    origin: '충남 논산시',
  },
  ...
  },
  {
    ...
    cloudinaryId: u('1476718406336-4b801f621069'),
    sizes: ['1인분'],
    stock: 48,
    origin: '충남 논산시',
  },
